...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">{{ utf8_encode(__('static.Edit')) }} {{ utf8_encode(__('static.Packaging')) }} <small></small></h1>
    <!-- end page-header -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="panel p-20">
                    {!! Form::model($info_Packaging, ['method' => 'PATCH', 'url' => ['/admin/packaging', $info_Packaging->id], 'id' => 'main-form']) !!}
                    <div class="row">
