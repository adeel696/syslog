...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active">{{ utf8_encode(__('static.Packaging')) }}</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">{{ utf8_encode(__('static.Packaging')) }} <small></small></h1>
    <!-- end page-header -->
                        ...
                        <table id="viewForm" class="table table-td-valign-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ utf8_encode(__('static.Detail')) }}</th>
...
<script type="text/javascript">
	...
	$('#viewForm').on('click', '#btnDelete[data-remote]', function (e) { 
		if (confirm("Are you sure to delete packaging?")) {		
			e.preventDefault();		 
