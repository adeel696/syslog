...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item"><a href="{{ url('admin/city') }}">{{ utf8_encode(__('static.City')) }}</a></li>
        <li class="breadcrumb-item active">{{ utf8_encode(__('static.Edit')) }}</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">{{ utf8_encode(__('static.Edit')) }} {{ utf8_encode(__('static.City')) }} <small></small></h1>
    <!-- end page-header -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="panel p-20">
                    {!! Form::model($info_City, ['method' => 'PATCH', 'url' => ['/admin/city', $info_City->id], 'id' => 'main-form']) !!}
                    <div class="row">
