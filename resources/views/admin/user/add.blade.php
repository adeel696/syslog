        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="panel p-20">
                    {!! Form::open([ 'url' => '/admin/user', 'files' => true, 'id' => 'main-form' ]) !!}
                    <div class="row">
                    ...
                    <div class="row">
                       <div class="col-md-6 col-sm-6 col-xs-6 col-xs-6 form-group">
                          ...
                          {!! Form::password('password', ['class' => 'form-control' , 'required' , 'placeholder' => utf8_encode(__('static.Password')), 'id' => 'password']) !!}
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-6 col-xs-6 form-group">
                          ...
                          {!! Form::password('password_confirmation', ['class' => 'form-control' , 'required' , 'placeholder' => utf8_encode(__('static.Confirm')) .' '. utf8_encode(__('static.Password')), 'id' => 'password_confirmation']) !!}
                    ...
                    <div class="row">
                       	<div class="col-md-12 col-sm-12 col-xs-12 col-xs-12 form-group">
                            ...
                            <p>
                                <input name="booking" type="checkbox" data-render="switchery" data-theme="primary" checked /> 
                                <span class="m-l-5 m-r-20">{{ utf8_encode(__('static.Booking')) }}</span>
                            </p>
                            <p>
                                <input name="users" type="checkbox" data-render="switchery" data-theme="primary" checked /> 
                                <span class="m-l-5 m-r-20">{{ utf8_encode(__('static.Users')) }}</span>
                            </p>
                            <p>
                                <input name="fares" type="checkbox" data-render="switchery" data-theme="primary" checked /> 
                                <span class="m-l-5 m-r-20">{{ utf8_encode(__('static.Fares')) }}</span>
                            </p>
                            <p>
                                <input name="vehicles" type="checkbox" data-render="switchery" data-theme="primary" checked /> 
                                <span class="m-l-5 m-r-20">{{ utf8_encode(__('static.Vehicles')) }}</span>
                            </p>
                            <p>
                                <input name="construction_machines" type="checkbox" data-render="switchery" data-theme="primary" checked /> 
                                <span class="m-l-5 m-r-20">{{ utf8_encode(__('static.Construction')) }} {{ utf8_encode(__('static.Machines')) }}</span>
                            </p>
                            <p>
                                <input name="offer" type="checkbox" data-render="switchery" data-theme="primary" checked /> 
                                <span class="m-l-5 m-r-20">{{ utf8_encode(__('static.Offer')) }}</span>
                            </p>
                            <p>
                                <input name="packaging" type="checkbox" data-render="switchery" data-theme="primary" checked /> 
                                <span class="m-l-5 m-r-20">{{ utf8_encode(__('static.Packaging')) }}</span>
                            </p>
                            <p>
                                <input name="goods_deals" type="checkbox" data-render="switchery" data-theme="primary" checked /> 
                                <span class="m-l-5 m-r-20">{{ utf8_encode(__('static.Goods')) }} {{ utf8_encode(__('static.Deals')) }}</span>
                            </p>
                            <p>
                                <input name="cities" type="checkbox" data-render="switchery" data-theme="primary" checked /> 
