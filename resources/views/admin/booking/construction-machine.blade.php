                    ...
                    <div class="table-responsive">
                    	<div class="panel">
                        	<div class="panel-heading">
                                ...
                                <input type="radio" class="statusChk" name="statusChk" value="2" /> {{ utf8_encode("Fermé") }}
...
<script type="text/javascript">
    $('#viewForm').DataTable({
        "processing": true,
        "serverSide": true,
		"ajax": "{{url('/admin/booking/construction-machine/grid')}}/0",
        "columns": [
			{ data: 'id', name: 'id' },
	...
	$(document).on('change', '.statusChk', function (e) {
		e.preventDefault();		 
		$('#viewForm').DataTable().ajax.url( "{{url('/admin/booking/construction-machine/grid')}}/"+$(this).val() ).load();
	});
